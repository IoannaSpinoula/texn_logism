      ...
      tabItem(tabName = "information",
              fluidPage(
                box(
                  ...
                  p("Developed by: Ioanna Spinoula inf2021211 (application and report), Despina Makri inf2021128 (application and report), Panagiotis Trachanas inf2021227 (application and report)")
                ),
                box(
